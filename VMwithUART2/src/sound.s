...
// CM / Clock Manager
.equ CM_BASE, 0x101000;  // Clock Manager Base Address
...
.equ CM_PWMCTL, 0x0A0; // Clock Manager PWM Clock Control
.equ CM_PWMDIV, 0x0A4; // Clock Manager PWM Clock Divisor
...
.equ CM_SRC_OSCILLATOR, 0x01; // Clock Control: Clock Source = Oscillator
...
.equ CM_SRC_PLLCPER, 0x05; // Clock Control: Clock Source = PLLC Per
...
.equ CM_KILL, 0x20;			   // Clock Control: Kill The Clock Generator
...
.equ CM_PASSWORD,  0x5A000000; // Clock Control: Password "5A"
// DMA Controller
...
.equ GPIO_FSEL0_IN,  0x0; // GPIO Function Select: GPIO Pin X0 Is An Input
.equ GPIO_FSEL0_OUT, 0x1;  // GPIO Function Select: GPIO Pin X0 Is An Output
.equ GPIO_FSEL0_ALT0, 0x4; // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 0
.equ GPIO_FSEL0_ALT1, 0x5; // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 1
.equ GPIO_FSEL0_ALT2, 0x6; // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 2
.equ GPIO_FSEL0_ALT3, 0x7; // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 3
.equ GPIO_FSEL0_ALT4, 0x3; // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 4
.equ GPIO_FSEL0_ALT5, 0x2; // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 5
.equ GPIO_FSEL0_CLR,  0x7; // GPIO Function Select: GPIO Pin X0 Clear Bits
...
.equ PWM_BASE, 0x20C000; // PWM Base Address
.equ PWM_CTL, 0x0; // PWM Control
.equ PWM_STA, 0x4; // PWM Status
.equ PWM_DMAC, 0x8; // PWM DMA Configuration
.equ PWM_RNG1, 0x10; // PWM Channel 1 Range
.equ PWM_DAT1, 0x14; // PWM Channel 1 Data
.equ PWM_FIF1, 0x18; // PWM FIFO Input
.equ PWM_RNG2, 0x20; // PWM Channel 2 Range
.equ PWM_DAT2, 0x24; // PWM Channel 2 Data

.equ PWM_PWEN1, 0x1; // PWM Control: Channel 1 Enable
.equ PWM_MODE1, 0x2; // PWM Control: Channel 1 Mode
.equ PWM_RPTL1, 0x4; // PWM Control: Channel 1 Repeat Last Data
.equ PWM_SBIT1, 0x8; // PWM Control: Channel 1 Silence Bit
.equ PWM_POLA1, 0x10; // PWM Control: Channel 1 Polarity
.equ PWM_USEF1, 0x20; // PWM Control: Channel 1 Use Fifo
.equ PWM_CLRF1, 0x40; // PWM Control: Clear Fifo
.equ PWM_MSEN1, 0x80; // PWM Control: Channel 1 M/S Enable
.equ PWM_PWEN2, 0x100; // PWM Control: Channel 2 Enable
.equ PWM_MODE2, 0x200; // PWM Control: Channel 2 Mode
.equ PWM_RPTL2, 0x400; // PWM Control: Channel 2 Repeat Last Data
.equ PWM_SBIT2, 0x800; // PWM Control: Channel 2 Silence Bit
.equ PWM_POLA2, 0x1000; // PWM Control: Channel 2 Polarity
.equ PWM_USEF2, 0x2000; // PWM Control: Channel 2 Use Fifo
.equ PWM_MSEN2, 0x8000; // PWM Control: Channel 2 M/S Enable
