...
volatile uint32_t* PWM = (uint32_t*)(PERIPHERAL_BASE + PWM_BASE);
volatile uint32_t* GPIO = (uint32_t*)(PERIPHERAL_BASE + GPIO_BASE);
...
void init_audio_jack(void)
{
	...
	PWM[PWM_RNG1] = 0x2C48; // Range = 13bit 44100Hz Mono
	PWM[PWM_RNG2] = 0x2C48; // Range = 13bit 44100Hz Mono
